...
function headers(_actionHeaders, _errorHeaders, _loaderHeaders, _parentHeaders) {
  return {
...
async function loader() {
  var data = await fetch("https://baconipsum.com/api/?type=meat-and-filler").then(function (prim) {
          return prim.json();
        }).then(function (t) {
